...
<div class="wrapper">
  ...
  {{-- <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="/temp/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div> --}}
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <span style="line-height: 35px;" class="text-muted text-sm">Xin chào {{Auth::user()->name}}</span>
      </li>

      <form method="POST" action="{{ route('logout') }}" class="nav-item">
        @csrf
        <a href="#" class="nav-link" role="button" onclick="event.preventDefault(); this.closest('form').submit();">
